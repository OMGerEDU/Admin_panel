    ...
    "he": {
        "translation": {
            ...
            "landing": {
                ...
                "integrations": {
                    "title": "חיבור לכל CRM",
                    "subtitle": "עובדים ב-monday, fireberry, origami או כל מערכת אחרת?\nהתוסף שלנו יפתח לכם את הצ׳אט בלחיצה על מספר טלפון בכל מערכת!"
                },
                "faq": {
                    "heading": "שאלות נפוצות",
                    "q1": "איך עובד התוסף בפועל?",
                    "a1": "התוסף מזהה אוטומטית מספרי טלפון בכל דף אינטרנט ומוסיף אייקון לחיץ שפותח צ'אט וואטסאפ מיידית.",
                    "q2": "באילו מערכות זה נתמך?",
                    "a2": "התוסף עובד על כל מערכת מבוססת דפדפן כולל Monday, Salesforce, HubSpot, Fireberry, Origami ועוד.",
                    "q3": "צריך לסרוק ברקוד כל פעם מחדש?",
                    "a3": "לא! הסריקה מתבצעת פעם אחת בלבד בעת החיבור, והחיבור נשמר פעיל.",
                    "q4": "כמה משתמשים יכולים להתחבר לתוסף?",
                    "a4": "תלוי בחבילה שבחרת. חבילת יחיד תומכת במשתמש אחד, בעוד חבילת עסקים מאפשרת כמות בלתי מוגבלת של משתמשים."
                },
                "pricing": {
                    "heading": "בחירת מסלול",
                    "subheading": "חיוב חודשי. ללא התחייבויות.",
                    "cta_trial": "התחל 30 ימי ניסיון ◀",
                    "features": {
                        "click_to_chat": "וואטסאפ בקליק מכל מערכת",
                        "crm_compat": "תואם לכל CRM",
                        "browser_install": "התקנה בקליק דרך הדפדפן",
                        "specialized": "במיוחד למשתמשי מערכות GreenAPI & SmartSend",
                        "money_back": "החזר כספי מלא עד 10 ימי ניסיון",
                        "trial": "30 ימי ניסיון ללא עלות וללא כרטיס אשראי"
                    },
                    "starter": {
                        "title": "משתמש יחיד",
                        "price": "39₪",
                    ...
                    "pro": {
                        "title": "חבילת 3 משתמשים",
                        "price": "99₪",
                        "period": "לחודש",
                        "badge": "הפופולרי ביותר"
                    },
                    "business": {
                        "title": "ללא הגבלת משתמשים",
                        "price": "199₪",
                        "period": "לחודש",
                        "badge": "המשתלם ביותר"
                    }
